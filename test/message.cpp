...
TYPED_TEST_SUITE(test_message_coder, is_safe_types, test_name_generator);
...
TYPED_TEST(test_message_coder, encode) {
    {
        ...
        ASSERT_TRUE(get_value_from_result<TestFixture::is_safe>(
            message_coder<decltype(m)>::encode<TestFixture::is_safe>(m, a), n));
...

    {
        ...
        array<byte, 30> a{};
        bytes n;
        ASSERT_TRUE(get_value_from_result<TestFixture::is_safe>(message_coder<decltype(m)>::encode<TestFixture::is_safe>(m, a), n));
...

    {
        ...
        Class c;
        bytes n;
        ASSERT_TRUE(get_value_from_result<TestFixture::is_safe>(message_coder<Class>::encode<TestFixture::is_safe>(c, buffer), n));
    }
...
TYPED_TEST(test_message_coder, decode) {
    {
        ...
        ASSERT_TRUE(get_value_from_result<TestFixture::is_safe>(message_coder<decltype(m)>::decode<TestFixture::is_safe>(a), value));
...
TYPED_TEST(test_message_coder, nested_encode) {
    {
        ...
        array<byte, 10> a{};
        bytes n;
        ASSERT_TRUE(get_value_from_result<TestFixture::is_safe>(message_coder<decltype(m2)>::encode<TestFixture::is_safe>(m2, a), n));
...

    {
        ...
        bytes bufferEnd;
        ASSERT_TRUE(get_value_from_result<TestFixture::is_safe>(message_coder<Class>::encode<TestFixture::is_safe>(myClass, buffer), bufferEnd));
        EXPECT_EQ(begin_diff(bufferEnd, buffer), 45);

        // deserialization
        decode_value<Class> value;
        ASSERT_TRUE(get_value_from_result<TestFixture::is_safe>(message_coder<Class>::decode<TestFixture::is_safe>(buffer), value));
...
TYPED_TEST(test_message_coder, nested_decode) {
    {
        ...
        ASSERT_TRUE(get_value_from_result<TestFixture::is_safe>(message_coder<decltype(m2)>::decode<TestFixture::is_safe>(a), value));
        const auto& [v, n] = value;
        EXPECT_EQ(begin_diff(n, a), 5);
